module StylesHelper
  ...
  def td_class
    class_variants(
      "p-2 whitespace-no-wrap text-sm leading-5 font-medium text-gray-900",
      variants: {
        text_align: {
          left: "text-left",
          center: "text-center",
  ...
  def th_class
    class_variants(
      "p-3 border-b border-gray-200 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider",
      variants: {
        text_align: {
          left: "text-left",
          center: "text-center",
