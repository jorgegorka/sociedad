module LinksHelper
  def link_class
    class_variants(
      "text-sm leading-4 font-medium text-indigo-700 hover:text-indigo-500 focus:outline-none focus:shadow-outline-indigo active:bg-indigo-200 transition ease-in-out duration-150",
      variants: {
  ...
  def dropdown_class
    class_variants(
      "px-4 py-2 inline-flex items-center text-sm leading-4 w-full font-medium text-sky-700 hover:bg-sky-100 hover:text-sky-500 focus:outline-none focus:shadow-outline-sky active:bg-sky-200 transition ease-in-out duration-150"
    )
  end
  ...
  def edit_class
    class_variants(
      "inline-flex mr-2 items-center px-2 py-1 text-xs leading-4 font-medium rounded text-teal-700 bg-teal-100 hover:bg-teal-50 focus:outline-none focus:shadow-outline-teal active:bg-teal-200 transition ease-in-out duration-150",
      variants: {
        border: {
  ...
  def sidebar_icon_class
    class_variants(
      "mr-3 h-6 w-6 text-hq-blue-700 group-hover:text-hq-blue-600 ease-in-out duration-150"
    )
  end

  def sidebar_class
    class_variants(
      "group flex items-center px-2 py-2 text-sm text-hq-blue-700 leading-5 font-medium rounded-md hover:bg-hq-pink-300 focus:bg-hq-pink-300 hover:text-hq-blue-700 focus:outline-none ease-in-out duration-150",
      variants: {
        bg: {
